...
{
    // Emulator-friendly OpenNOW builds avoid hid:sys capture/home event handles.
    // Several Yuzu/Ryujinx builds assert on AcquireCaptureButtonEventHandle even
    // though standard controller polling works fine through padUpdate below.
